...
// This is necessary to work around a bug where unwind segues don't work correctly in certain situations in iOS 8.0
// See http://stackoverflow.com/a/25842508 for full details
...
public class CustomTabBarController: UITabBarController {
    ...
    public func viewControllerForUnwindSegueAction(action: Selector, fromViewController: UIViewController, withSender sender: AnyObject?) -> UIViewController? {
        ...
        return self
            ...
            //.forUnwindSegueAction(action, from: fromViewController, withSender: sender)
