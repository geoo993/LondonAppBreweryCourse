...
public class AddressParser: NSObject{
    ...
    public func parseAppleLocationData(_ placemark: CLPlacemark){
    ...
    public func parseGoogleLocationData(_ resultDict: NSDictionary){
    ...
    public func component(_ component:NSString,inArray:NSArray,ofType:NSString) -> NSString{
