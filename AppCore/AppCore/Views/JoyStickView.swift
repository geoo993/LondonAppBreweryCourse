...
public class JoyStickView: UIView {
    ...
    @IBInspectable
    public var baseAlpha: CGFloat = 0 {
        didSet {
...
//            }
    ...
    @IBInspectable
    public var handleTintColor: UIColor = UIColor.white  {
        didSet {
            makeHandleImage()
        }
    }
    ...
    @IBInspectable
    public var baseImage: UIImage = UIImage() {
        didSet {
            makeHandleImage()
        }
    }
    ...
    @IBInspectable
    public var handleImage: UIImage = UIImage() {
        didSet {
            makeHandleImage()
        }
    }
    ...
    private func updateLocation(location: CGPoint) {
        ...
        //
        let delta: CGPoint = location - frame.center
        ...
        if movable {
            if newDisplacement > 1.0 {
                ...
                //
                let origin = location - end - frame.size.toPoint / 2.0
            ...
            //
            handleImageView.center = bounds.center + delta
        }
        else {
