...
extension AnimatedSink where Base: UIView {
    ...
    func fade(duration: TimeInterval) -> AnimatedSink<Base> {
    ...
    func flip(_ direction: FlipDirection, duration: TimeInterval) -> AnimatedSink<Base> {
    ...
    func tick(_ direction: FlipDirection = .right, duration: TimeInterval) -> AnimatedSink<Base> {
    ...
    func animation(duration: TimeInterval, options _: UIView.AnimationOptions = [], animations: @escaping () -> Void) -> AnimatedSink<Base> {
...
extension AnimatedSink where Base: NSLayoutConstraint {
    ...
    func layout(duration: TimeInterval) -> AnimatedSink<Base> {
